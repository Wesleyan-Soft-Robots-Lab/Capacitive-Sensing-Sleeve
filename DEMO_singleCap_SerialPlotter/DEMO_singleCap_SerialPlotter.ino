/*
Name: Miles Modeste **branch from multicap.ino
Date Created: 6/9/2025
Last Updated: 6/9/2025

Description:
  Example script to demonstrate single sensor. eg: capdac, msb, capacitance 
  in the Serial Plotter

Hardware Setup:
  - One sensor patch hooked up to channel ONEA via multiplexor on port 7
...
public:
  ...
  void UpdateSensor() {
    ...
    if (!FDC.readMeasurement(channel, value)) {
      ...
      // Uncomment to see how msb works. **Tip: using more than one sensor gets too crowded
      /* Serial.print("msb:");
      Serial.print(msb);
      Serial.print(", lsb:");
      Serial.print(lsb);
